...
export const MESSAGES = {
  es: {
    ...
    'sol.edit': 'Editar',
    'sol.editTitle': 'Editar solicitud',
    'sol.by': 'por {name}',
    ...
    'toast.reqUpdated': 'Solicitud actualizada',
    ...
    'login.email': 'Correo',
    'hist.createdBy': 'registró',
    'nav.usuarios': 'Usuarios',
    'header.title.usuarios': 'Usuarios',
    'header.subtitle.usuarios': 'Gestiona las cuentas del equipo',
    'users.new': 'Nuevo usuario',
    'users.email': 'Correo',
    'users.domain': 'candelasoft.com',
    'users.nombre': 'Nombre',
    'users.ph.nombre': 'Nombre y apellido',
    'users.role': 'Rol',
    'users.roleAdmin': 'Administrador',
    'users.roleMember': 'Miembro',
    'users.password': 'Contraseña inicial',
    'users.ph.password': 'Mínimo 6 caracteres',
    'users.create': 'Crear usuario',
    'users.resetPassword': 'Cambiar contraseña',
    'users.delete': 'Eliminar usuario',
    'users.deleteConfirm': '¿Eliminar al usuario {email}?',
    'users.resetPrompt': 'Nueva contraseña para {email}:',
    'users.passwordReset': 'Contraseña actualizada para {email}',
    'users.you': 'tú',
    'users.error': 'No se pudo completar la acción',
  },
  en: {
    'nav.resumen': 'Summary',
    ...
    'toast.reqUpdated': 'Request updated',
    ...
    'login.email': 'Email',
    'hist.createdBy': 'created by',
    'nav.usuarios': 'Users',
    'header.title.usuarios': 'Users',
    'header.subtitle.usuarios': 'Manage the team accounts',
    'users.new': 'New user',
    'users.email': 'Email',
    'users.domain': 'candelasoft.com',
    'users.nombre': 'Name',
    'users.ph.nombre': 'Full name',
    'users.role': 'Role',
    'users.roleAdmin': 'Administrator',
    'users.roleMember': 'Member',
    'users.password': 'Initial password',
    'users.ph.password': 'At least 6 characters',
    'users.create': 'Create user',
    'users.resetPassword': 'Change password',
    'users.delete': 'Delete user',
    'users.deleteConfirm': 'Delete user {email}?',
    'users.resetPrompt': 'New password for {email}:',
    'users.passwordReset': 'Password updated for {email}',
    'users.you': 'you',
    'users.error': 'Could not complete the action',
  },
  de: {
    ...
    'sol.edit': 'Bearbeiten',
    'sol.editTitle': 'Anfrage bearbeiten',
    'sol.by': 'von {name}',
    ...
    'toast.reqUpdated': 'Anfrage aktualisiert',
    ...
    'login.email': 'E-Mail',
    'hist.createdBy': 'erfasst von',
    'nav.usuarios': 'Benutzer',
    'header.title.usuarios': 'Benutzer',
    'header.subtitle.usuarios': 'Team-Konten verwalten',
    'users.new': 'Neuer Benutzer',
    'users.email': 'E-Mail',
    'users.domain': 'candelasoft.com',
    'users.nombre': 'Name',
    'users.ph.nombre': 'Vor- und Nachname',
    'users.role': 'Rolle',
    'users.roleAdmin': 'Administrator',
    'users.roleMember': 'Mitglied',
    'users.password': 'Initiales Passwort',
    'users.ph.password': 'Mindestens 6 Zeichen',
    'users.create': 'Benutzer erstellen',
    'users.resetPassword': 'Passwort ändern',
    'users.delete': 'Benutzer löschen',
    'users.deleteConfirm': 'Benutzer {email} löschen?',
    'users.resetPrompt': 'Neues Passwort für {email}:',
    'users.passwordReset': 'Passwort aktualisiert für {email}',
    'users.you': 'du',
    'users.error': 'Aktion konnte nicht abgeschlossen werden',
  },
}
