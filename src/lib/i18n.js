...
export const MESSAGES = {
  es: {
    ...
    'sol.link': 'Link del producto (opcional)',
    'sol.ph.link': 'https://…',
    'sol.viewLink': 'Ver enlace',
  ...
  en: {
    ...
    'sol.link': 'Product link (optional)',
    'sol.ph.link': 'https://…',
    'sol.viewLink': 'Open link',
  ...
  de: {
    ...
    'sol.link': 'Produktlink (optional)',
    'sol.ph.link': 'https://…',
    'sol.viewLink': 'Link öffnen',
