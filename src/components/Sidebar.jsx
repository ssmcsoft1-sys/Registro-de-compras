import { LayoutDashboard, PlusCircle, List, Send, Users, LogOut } from 'lucide-react'
...
const NAV_MANAGER = [
  ...
  { id: 'usuarios', key: 'nav.usuarios', Icon: Users },
]
const NAV_TEAM = [
  { id: 'registrar', key: 'nav.registrar', Icon: PlusCircle },
  { id: 'historial', key: 'nav.historial', Icon: List },
...
export default function Sidebar({ role, user, view, onNavigate, onLogout }) {
  ...
  return (
    <aside className="sidebar">
      ...
      {user?.email && <div className="sidebar__user" title={user.email}>{user.email}</div>}
